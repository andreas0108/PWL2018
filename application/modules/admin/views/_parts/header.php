                        ...
                        <?php if ($this->session->userdata('logged_in')) { ?>
                            <div class="col-sm-3 col-md-3 col-lg-2 left-side navbar-default">
                                ...
                                <ul class="sidebar-menu" id="accordion">
                                    ...
                                    <li class="header collapsed" data-toggle="collapse" data-parent="#accordion" href="#ECOM" aria-expanded="true" aria-controls="ECOM">MAIN</li>
                                    <div class="collapse in" id="ECOM">
                                    ...
                                    <?php if (in_array('blog', $activePages)) { ?>                                        
                                        <li class="header collapsed" data-toggle="collapse" data-parent="#accordion" href="#BLOG" aria-expanded="false" aria-controls="BLOG">BLOG</li>
                                    ...
                                    if (!empty($textualPages)) {
                                        ...
                                        ?>
                                        <li class="header collapsed" data-toggle="collapse" data-parent="#accordion" href="#TEXPAGE" aria-expanded="false" aria-controls="TEXPAGE">TEXTUAL PAGES</li>
                                        <?php foreach ($textualPages as $textualPage) { ?>
                                            <div class="collapse" id="TEXPAGE">
                                    ...
                                    <li class="header collapsed" data-toggle="collapse" data-parent="#accordion" href="#SETTINGS" aria-expanded="false" aria-controls="SETTINGS">SETTINGS</li>
                                    ...
                                    <li class="header collapsed" data-toggle="collapse" data-parent="#accordion" href="#ASETTINGS" aria-expanded="false" aria-controls="ASETTINGS">ADVANCED SETTINGS</li>
                                    <div class="collapse" id="ASETTINGS">
