...
<div class="row">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
        <div class="panel-heading collapsed" data-toggle="collapse" data-target="#SocialML">Social Media Links <i class="chevron fa fa-fw" ></i></div>
            <div class="panel-body collapse" id="SocialML">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
        <div class="panel-heading collapsed" data-toggle="collapse" data-target="#ContPage">Contacts Page <i class="chevron fa fa-fw" ></i></div>
            <div class="panel-body collapse" id="ContPage">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            <div class="panel-heading collapsed" data-toggle="collapse" data-target="#ContFoot">Contact Footer <i class="chevron fa fa-fw" ></i></div>
            <div class="panel-body collapse" id="ContFoot">
    ...
    <div class="col-sm-6 col-md-4">
        <div class="panel panel-success col-h">
            <div class="panel-heading collapsed" data-toggle="collapse" data-target="#CookieLaw">Cookie Law Notification <i class="chevron fa fa-fw" ></i></div>
            <div class="panel-body collapse" id="CookieLaw">
                ...
                <form method="POST" action="">
                    ...
                    <?php } foreach ($languages as $language) { ?>
                        <div class="form-group">
                            <label for="message-cookie-law">Message </label>
                    ...
                    <?php } foreach ($languages as $language) {
                        ?>
                        <div class="form-group">
                            <label for="btn-cookie-law">Button Text </label>
                    ...
                    <?php } foreach ($languages as $language) { ?>
                        <div class="form-group">
                            <label for="learn_more">Learn More :</label>
